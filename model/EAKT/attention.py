...
class Encoder(nn.Module):
    ...
    def __init__(self, h, length, d_model, dropout):
        ...
        self.feed_forward = PositionwiseFeedForward(d_model, d_model * 4)#位置信息模块
...
class SublayerConnection(nn.Module):
    ...
    def forward(self, x, sublayer):
        ...
        return x + self.dropout(sublayer(self.norm(x)))#norm->sublayer->dropout-> + x_tensor
